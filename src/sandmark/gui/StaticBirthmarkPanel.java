...
public class StaticBirthmarkPanel extends SkinPanel
   ...
   private sandmark.util.ConfigProperties mConfigProps =
      sandmark.birthmark.StaticClassBirthMarkParameters.buildProperties();
   
   public StaticBirthmarkPanel(SandMarkFrame frame){
      ...
      mComboBox = new AlgorithmComboBox(this,
         sandmark.util.classloading.IClassFinder.STAT_BIRTHMARK);
            ...
            Thread obfuscationRunner = new Thread() {
               public void run() {
                  try {
                     ...
                     sandmark.birthmark.StaticClassBirthmark alg = 
                        (sandmark.birthmark.StaticClassBirthmark)
                        mComboBox.getCurrentAlgorithm();
                     double percent = alg.calculate
                        (sandmark.birthmark.StaticClassBirthMarkParameters.buildParams
                         (mConfigProps,getApplication()));
...
*/
   ...
   public void setAlgorithm(sandmark.Algorithm alg) {
      ...
      mCPP = new ConfigPropertyPanel(
         new sandmark.util.ConfigProperties[]{
            ...
            mConfigProps,alg.getConfigProperties()
         },sandmark.util.ConfigProperties.PHASE_STATIC_BIRTHMARK,
   ...
   public void showDescription() {
    ...
    return "This pane allows you to choose between a number " +
               "of different birthmark algorithms to test for program similarity."; 
    }
